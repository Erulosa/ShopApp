...
public class Window extends JFrame {
    ...
    public Window() {
        ...
        tableModel = new InteractiveTableModel(new String[]{"Item ", "Quality", "Price", ""});
        shopIndex = -1;
        createWindow();
    }
   ...
   setLocationRelativeTo(null);
        ...
        createEditTab();
        createSaveTab();
        jtp.addTab("Open network info", jp1);
        jtp.addTab("Edit", jp2);
        jtp.addTab("Save", jp3);
        setVisible(true);
    }
    ...
    private void createOpenTab() {
        jp1.setLayout(null);
        JLabel label1 = new JLabel("Shop choice:");
    ...
    private void createEditTab() {
        ...
        JLabel label1 = new JLabel("Shop choice:");
        label1.setBounds(10, 10, 100, 20);
        delButton = new JButton("<html><center> Delete shop </center></html>");
   delButton.setEnabled(false);
        JButton addButton = new JButton("<html><center>Add shop</center></html>");
        ...
        editButton = new JButton("<html><center>Edit shop</center></html>");
        ...
        addCButton = new JButton("<html><center>Add item</center></html>");
        ...
        JButton delCButton = new JButton("<html><center> Delete item</center></html>");
        ...
        JButton exitButton = new JButton("<html><center> Exit </center></html>");
        ...
        saveButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    jLabel.setText("Data was successfully saved!");
                    jLabel.setForeground(new Color(0, 228, 0));
                } catch (IOException e1) {
                    jLabel.setText("Error while saving");
    ...
    private void addShop() {
        ...
        dialog.setTitle("New shop");
        dialog.setSize(300, 160);
        dialog.setLocationRelativeTo(null);
        JLabel jlabel = new JLabel("Give the name of the shop:");
    ...
    private void editShop(final Shop shop) {
        ...
        final JDialog dialog = new JDialog(this, true);
        dialog.setResizable(false);
        dialog.setTitle("Edit shop");
        dialog.setSize(300, 160);
        dialog.setLocationRelativeTo(null);
        JLabel jlabel = new JLabel("Write the new name of the shop:");
        jlabel.setBounds(10, 10, 180, 20);
        final JButton createButton = new JButton("Save");
    ...
    private void addCommodity() {
        ...
        JLabel jlabel = new JLabel("Flower name: ");
        jlabel.setBounds(10, 10, 90, 25);
        JLabel countLabel = new JLabel("Quality: ");
